<template>
    <footer>
        <div class="new-level" id="form">
            ...
            <p class="p-new-level">
                Мы поможем вам стать лидером мобильной коммерции в России и за её пределами!
            </p>
        ...
        <form class="form" @submit.prevent="submitForm">
            ...
            <div class="form-group">
                <input v-model="formData.phone" type="tel" placeholder="Номер телефона*" />
                <span v-if="errors.phone" class="error">{{ errors.phone }}</span>
            </div>
            <div class="form-group">
                <input v-model="formData.business" type="text" placeholder="Сфера бизнеса" />
